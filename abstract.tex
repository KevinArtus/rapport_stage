...
\begin{abstract}
Open Orchestra est un CMS open-source, multi-sites, multi-langues, multi-devices, réalisé avec le framework PHP symfony2, conçu pour être hautement flexible et personnalisable.
 En version bêta depuis un an, la première version est prévue pour le mois de septembre.
\paragraph{}
